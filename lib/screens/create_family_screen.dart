...
class _CreateFamilyScreenState extends State<CreateFamilyScreen> {
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                const Padding(
                  ...
                  child: Text('Fill in', style: TextStyle(fontSize: 38, fontWeight: FontWeight.bold, color: Color(0xffc95664))),
                ),
                const Padding(
                  padding: EdgeInsets.only(left: 30.0),
                  child: Text('your profile :)', style: TextStyle(fontSize: 38, fontWeight: FontWeight.bold)),
                ),
                const SizedBox(height: 20,),
                const Padding(
                  padding: EdgeInsets.only(left: 30.0),
                  child: Text('Enter all required fields about your personal information'),
                ),
                const SizedBox(height: 20,),
                Padding(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                    border: InputBorder.none,
                                    hintText: 'Date of birth eg. 12/09/1899',
                                    hintStyle: TextStyle(color: Colors.grey[500])
                                ),
                              ),
                            ),
  ...
  Widget _submitButton() {
    return GradientButton(
      ...
      buttonText: 'Create', color: const Color(0xff0a2768),
    );
  }
